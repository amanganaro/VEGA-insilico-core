...
public class SAMicronucleusInVivo extends AlertBlockFromSMARTS implements iAlertBlock {
    ...
    public SAMicronucleusInVivo() throws InitFailureException {
        super(InsilicoConstants.SA_BLOCK_MICRONUCLEUS_INVIVO, "Rules for In Vivo Micronucleus activity");     
    }
    ...
    protected void BuildSAList() throws InitFailureException {
        ...
        for (int i=0; i<SMARTS.length; i++) {
            ...
            curSA.setName("MN alert no. " + (i+1) + " for " + SMARTS[i][2] + " compounds");
            curSA.setDescription("Structural alert for in vivo micronucleus activity defined by the SMARTS: " + SMARTS[i][0] + ". It is related to " + SMARTS[i][2] + " compounds");
