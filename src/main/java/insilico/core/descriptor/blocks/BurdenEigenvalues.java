...
public class BurdenEigenvalues extends DescriptorBlock {
    ...
    protected final void GenerateDescriptors() {
        ...
        bWeights.add(new insilico.core.descriptor.blocks.weights.basic.WeightsVanDerWaals());
        bWeights.add(new insilico.core.descriptor.blocks.weights.basic.WeightsElectronegativity());
        bWeights.add(new insilico.core.descriptor.blocks.weights.basic.WeightsPolarizability());
        bWeights.add(new insilico.core.descriptor.blocks.weights.basic.WeightsIonizationPotential());
