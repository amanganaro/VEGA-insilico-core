...
import insilico.core.descriptor.blocks.old.weight.IonizationPotential;
 ...
 */
public class PVSA extends DescriptorBlock {
    ...
    public void Calculate(InsilicoMolecule mol) {
        ...
        for (Integer curWeight : weightList) {
            ...
            if (curWeight == WEIGHT_MR_IDX)
                w = GhoseCrippenWeights.GetMolarRefractivity(m);
