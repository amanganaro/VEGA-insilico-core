...
@Data
@Slf4j
public class InsilicoModelInfo {
    ...
    public InsilicoModelInfo(URL XMLSource) throws InitFailureException {
        ...
        try {
            ...
            try {
                ...
                log.warn(StringSelectorCore.getString("ismodel_info_no_tag_version"));
            ...
            try {
                ...
                log.warn(StringSelectorCore.getString("ismodel_info_no_tag_vega"));
                log.warn(ex.getMessage());
            }
            ...
            try {
                ...
                log.warn(StringSelectorCore.getString("ismodel_info_no_tag_guide"));
                log.warn(ex.getMessage());
            }
            ...
            try {
                ...
                log.warn(StringSelectorCore.getString("ismodel_info_no_tag_reference"));
                log.warn(ex.getMessage());
            }
            ...
            try {
                ...
                log.warn(StringSelectorCore.getString("ismodel_info_no_tag_endpoint"));
                log.warn(ex.getMessage());
            }
            ...
            try {
                ...
                log.warn(StringSelectorCore.getString("ismodel_info_no_tag_stats"));
                log.warn(ex.getMessage());
            }
        } catch (Exception e) {
            throw new InitFailureException(String.format(StringSelectorCore.getString("ismodel_info_init_exception"), e.getMessage()));
        }
