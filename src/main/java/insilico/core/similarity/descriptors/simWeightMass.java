...
/**
 * Weighting scheme for mass. Values are taken from Dragon 5.5
 * documentation.<p>
 * NOTE: values are scaled on the reference value (Carbon). To obtain real
 * mass values, multiply weights for the actual Carbon mass (12.011).
 *
 * @author Alberto Manganaro (a.manganaro@kode-solutions.net)
 */
public class simWeightMass {

    /**
     * Calculate mass weights for all atoms in the given molecule, and returns
     * them in a single array. NOTE: values are scaled on the reference
     * value (Carbon).
     *
    ...
    /**
     * Returns the mass weight for the given atom type. NOTE: values are
     * scaled on the reference value (Carbon).
     *
     * @param AtomType atomtype symbol to be processed
     * @return the value of the weight
     */
    public static double GetMass(String AtomType) {
